          ...
          <div className="relative w-full md:w-1/2">
            ...
            <p className="mb-6 text-base text-neutral-600 dark:text-neutral-400">
              ...
              <span className="hidden lg:block">
                The handsome boy on the right is not me.
              </span>
            </p>
            ...
            <Button text="Follow me on 𝕏" link="https://twitter.com/ccbikai" />
          </div>
          <div className="relative justify-end hidden w-full mt-10 md:flex md:pl-10 md:w-1/2 md:mt-0 md:translate-y-4 xl:translate-y-0">
            <div className="relative z-50 w-full">
              ...
              <div className="relative z-30 px-10">
                <img
                  src="/static/img/20240508-182449.jpg"
                  loading="eager"
                  decoding="auto"
                  className="relative z-30 w-full aspect-[790/1189] md:max-w-md mx-auto dark:-translate-y-0.5"
                />
              </div>
